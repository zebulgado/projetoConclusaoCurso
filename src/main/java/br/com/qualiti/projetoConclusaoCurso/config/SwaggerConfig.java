package br.com.qualiti.projetoConclusaoCurso.config;
...
import br.com.qualiti.projetoConclusaoCurso.ProjetoConclusaoCursoApplication;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage(ProjetoConclusaoCursoApplication.class.getPackage().getName()))
